...
for {otp_app, repo, db_name} <- [
      {:bot_army_gtd, BotArmyGtd.Repo, "bot_army_gtd"},
      {:bot_army_llm, BotArmyLlm.Repo, "bot_army_llm"},
      {:bot_army_dispatcher, BotArmyDispatcher.Repo, "bot_army_dispatcher"},
      {:bot_army_skills, BotArmySkills.Repo, "bot_army_skills"},
      {:bot_army_job_scheduler, BotArmyJobScheduler.Repo, "bot_army_job_scheduler"}
    ] do
  config otp_app, repo,
    database: db_name,
    hostname: db_host,
